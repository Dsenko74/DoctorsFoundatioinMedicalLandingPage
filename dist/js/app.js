(() => {
    ...
    function initSliders() {
        if (document.querySelector(".panel__slider, .say__slider")) {
            new swiper_core_Swiper(".panel__slider", {
            ...
            new swiper_core_Swiper(".say__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                autoHeight: true,
                ...
                navigation: {
                    prevEl: ".say__arrow--right",
                    nextEl: ".say__arrow--left"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
    ...
    for (let i = 0; i < doctors.length; i++) doctors[i].addEventListener("click", (function(e) {
    ...
    function initDoctor(data, startItem, endItem, param) {
        ...
        dataPart.forEach(((item, i) => {
            if (param == "All") buildDoctorItem(item); else if (item.days == param || item.position.includes(param)) buildDoctorItem(item);
        }));
    }
    function buildDoctorItem(item) {
        ...
        item.image ? doctorItemTemplate += `<img src="${item.image}" alt="doctor">` : null;
    ...
    for (let i = 0; i < diaryItem.length; i++) diaryItem[i].addEventListener("click", (function(e) {
        for (let i = 0; i < diaryItem.length; i++) diaryItem[i].classList.remove("_active");
